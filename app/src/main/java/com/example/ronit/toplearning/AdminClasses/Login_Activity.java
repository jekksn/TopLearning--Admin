...
public class Login_Activity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public static Button buttonregistrieren;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button5.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(Login_Activity.this, activity_registrieren.class);
        ...
        button6.setOnClickListener(new OnClickListener() {
            public void onClick(View v1) {
                ...
                Intent intent15 = new Intent(Login_Activity.this, Password_Vergessen_Activity.class);
    ...
    private boolean isEmailValid(String email) {
        ...
        return email.contains("admin@hotmail.com");
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent intent = new Intent(Login_Activity.this, Admin_Welcome_Activity.class);
